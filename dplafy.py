...
dpla_data = "http://api.dp.la/v2/items?q=%22donald+trump%22+OR+motorcycle+OR+%22harley+davidson%22+OR+fries+OR+hamburger+OR+hotdog+OR+eagle+OR+flag+OR+beer+OR+beef+OR+war+OR+cow+OR+explosion+OR+explosive+OR+gun+OR+chrome&page_size=500&api_key=91b1bb54a822c576aa55d1b7a9babbd6"
